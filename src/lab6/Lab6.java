...
public class Lab6 extends GLJPanel implements GLEventListener {
	...
	public void display(GLAutoDrawable drawable) {
		...
		// float[] color = { 1.0f, 1.0f, 0.0f, 1f, 0.0f, 1.0f, 1.0f, 1f, 0.0f, 1.0f,
		// 0.0f, 1f, 50f };
		...
		gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[9], 8);

		gl2.glVertex3f(0.0f, 1.0f, 0.0f);
		gl2.glVertex3f(0.0f, -1.0f, -1.0f);
		gl2.glVertex3f(1.0f, -1.0f, 1.0f);

		gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, materials[12], 12);
		...
		var light_position = new float[] { 2.0f, 2.0f, 6.0f,1.0f};
		var light_direction = new float[] { 0.0f, 0.0f, -6.0f,0.0f };

		var light_position2 = new float[] { 16.0f, 2.0f, 7.0f, 1.0f };
		var light_direction2 = new float[] { 15.0f, 0.0f, -7.0f, 0.0f };


		gl2.glPushMatrix();
		gl2.glLightfv(GL2.GL_LIGHT0, GL2.GL_POSITION, light_position, 0);
		gl2.glLightf(GL2.GL_LIGHT0, GL2.GL_SPOT_CUTOFF, 100.0f);
		gl2.glLightfv(GL2.GL_LIGHT0, GL2.GL_SPOT_DIRECTION, light_direction, 0);
		gl2.glLightf(GL2.GL_LIGHT0, GL2.GL_SPOT_EXPONENT, 15.0f);
		gl2.glPopMatrix();

		gl2.glPushMatrix();
		gl2.glLightfv(GL2.GL_LIGHT1, GL2.GL_POSITION, light_position2, 0);
		gl2.glLightf(GL2.GL_LIGHT1, GL2.GL_SPOT_CUTOFF, 30.0f);
		gl2.glLightfv(GL2.GL_LIGHT1, GL2.GL_SPOT_DIRECTION, light_direction2, 0);
		gl2.glLightf(GL2.GL_LIGHT1, GL2.GL_SPOT_EXPONENT, 5.0f);
		gl2.glPopMatrix();
